<template>
  <nav
    class="fixed top-0 w-full backdrop-blur-md bg-base-100/10 transition-colors"
  >
    <div class="container px-4 navbar">
      ...
      <div class="hidden navbar-center lg:flex">
        <ul class="p-0 menu menu-horizontal">
          ...
          <li><a>Marketplace</a></li>
          <li><nuxt-link to="/mint">Create</nuxt-link></li>
        </ul>
      </div>
      <div class="navbar-end">
        ...
        <button
          ...
          class="btn btn-ghost btn-circle mr-5"
        >
          <!-- sun icon -->
          <svg
        ...
        <a
          v-if="!isConnected"
          @click.prevent="wallet.connect({ requestSignIn: true })"
